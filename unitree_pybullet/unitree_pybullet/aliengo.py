...
quadruped = p.loadURDF("aliengo/urdf/aliengo.urdf",[0,0,0.48],[0,0,0,1], flags = urdfFlags,useFixedBase=False)
...
while(1):
    # with open("mocap.txt","r") as filestream: #ファイルパスを修正
    mocap_path = os.path.join(os.path.dirname(__file__), "mocap.txt")
